...
def copy_std_bvh(data_path, character, files):
    ...
    """
    cmd = 'cp \"{}\" ./Mixamo/train_set/std_bvhs/{}.bvh'.format(data_path + character + '/' + files[0], character)
    os.system(cmd)


if __name__ == '__main__':
    prefix = './Mixamo/train_set'
    ...
    for character in characters:
        ...
        write_statistics(character, './Mixamo/train_set/mean_var/')
